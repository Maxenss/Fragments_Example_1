    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cb1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                Toast.makeText(getContext(), "Изменили состояние первого CheckBox'а", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        cb2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                Toast.makeText(getContext(), "Изменили состояние второго CheckBox'а", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        cb3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                Toast.makeText(getContext(), "Изменили состояние третьего CheckBox'а", Toast.LENGTH_SHORT).show();
            }
        });
